...
abstract class LanguageDetector_Test {
        ...
        fun getConfidenceValueArguments(): Stream<Arguments> {
            return Stream.of(
                ...
                "A dirlo è Jamil Sadegholvaad, assessore alla Sicurezza, in relazione agli atti vandalici e l’occupazione della palazzina ex Sert tra lanci di sedie e biciclette nella notte tra sabato e domenica."
                    to "ITALIAN (100.00%), LATIN (88.52%), ENGLISH (82.94%), FRENCH (80.72%), PORTUGUESE (78.98%), WELSH (77.55%), SPANISH (77.27%), TAGALOG (76.61%), CATALAN (76.24%), ROMANIAN (75.20%), SWEDISH (75.19%), YORUBA (75.07%), BOKMAL (73.94%), ESPERANTO (73.52%), ALBANIAN (73.11%), CROATIAN (72.72%), ESTONIAN (72.60%), DUTCH (72.47%), TURKISH (72.42%), OROMO (72.27%), NYNORSK (72.24%), HUNGARIAN (72.03%), DANISH (71.89%), VIETNAMESE (71.54%), GERMAN (71.25%), AFRIKAANS (71.02%), FINNISH (71.00%), BASQUE (70.75%), POLISH (70.63%), INDONESIAN (70.24%), SLOVENE (70.20%)",
        ...
        fun getMultiLanguageArguments(): Stream<Arguments> {
            ...
            return Stream.of(
                ...
                "...."
                    to "",
                "a"
                    to "0-1 (1): SOMALI; SOMALI (100%), OROMO (92%), SWAHILI (87%), TAGALOG (86%), MALAY (83%), INDONESIAN (80%), MAORI (79%), SHONA (77%), GANDA (77%), TSONGA (75%), TSWANA (74%), SOTHO (73%), IRISH (72%), BASQUE (72%) \n" +
                    "  a",
                "this is a test"
                    to "0-14 (11): ENGLISH; ENGLISH (100%), LATIN (97%), ESPERANTO (90%), ESTONIAN (88%), GERMAN (83%), PORTUGUESE (83%), FRENCH (83%), NYNORSK (83%), TAGALOG (82%), BOKMAL (82%), SPANISH (81%), DUTCH (81%), DANISH (81%), CATALAN (81%), FINNISH (81%), ROMANIAN (80%), WELSH (79%), POLISH (79%), ITALIAN (79%), XHOSA (79%), BOSNIAN (78%), SLOVAK (78%), ALBANIAN (78%), SWAHILI (78%), ZULU (78%), SWEDISH (77%), CZECH (76%), BASQUE (76%), SOTHO (76%), TURKISH (74%), AFRIKAANS (74%), SLOVENE (74%), CROATIAN (74%), HUNGARIAN (74%), YORUBA (72%), IRISH (72%), TSONGA (71%), SOMALI (71%), OROMO (71%), LITHUANIAN (71%), LATVIAN (70%), SHONA (70%), INDONESIAN (70%) \n" +
                    "  this is a test",
                "日本語1a"
                    to "0-4 (3): CHINESE; CHINESE (100%) \n" +
                    "  日本語1\n" +
                    // Exact confidence values for "a" here don't matter
                    "4-5 (1): SOMALI; SOMALI (100%), OROMO (92%), SWAHILI (87%), TAGALOG (86%), MALAY (83%), INDONESIAN (80%), MAORI (79%), SHONA (77%), GANDA (77%), TSONGA (75%), TSWANA (74%), SOTHO (73%), IRISH (72%), BASQUE (72%) \n" +
                    "  a",
                "हिन्दीa"
                    to "0-6 (3): HINDI; HINDI (100%), MARATHI (93%) \n" +
                    "  हिन्दी\n" +
                    // Exact confidence values for "a" here don't matter
                    "6-7 (1): SOMALI; SOMALI (100%), OROMO (92%), SWAHILI (87%), TAGALOG (86%), MALAY (83%), INDONESIAN (80%), MAORI (79%), SHONA (77%), GANDA (77%), TSONGA (75%), TSWANA (74%), SOTHO (73%), IRISH (72%), BASQUE (72%) \n" +
                    "  a",
                ...
                "When he came into the room, he greeted the others with \"Hallo zusammen, wie geht es euch?\" and sat down on a free chair."
                    to "0-54 (43): ENGLISH; ENGLISH (100%), TAGALOG (78%), XHOSA (77%), WELSH (76%), DUTCH (76%), GANDA (75%), OROMO (75%), YORUBA (75%), TSONGA (74%), AFRIKAANS (74%), LATIN (74%), ZULU (74%), BOKMAL (74%), DANISH (73%), TSWANA (73%), SOMALI (72%), ESPERANTO (72%), SLOVAK (71%), HUNGARIAN (71%), SPANISH (71%), ALBANIAN (71%), SWAHILI (71%), FRENCH (71%), INDONESIAN (71%), SHONA (70%), SWEDISH (70%), GERMAN (70%) \n" +
                ...
                "выдает такую ошибку Error Code: UNKNOWN code: Deep Ocean"
                    ...
                    "  выдает такую ошибку \n" +
                    "20-56 (29): ENGLISH; ENGLISH (100%), TAGALOG (84%), POLISH (83%), WELSH (82%), LATIN (81%), GERMAN (81%), ESPERANTO (81%), BOKMAL (80%), DUTCH (79%), ALBANIAN (78%), INDONESIAN (78%), SPANISH (78%), DANISH (78%), BASQUE (78%), SWEDISH (77%), YORUBA (77%), NYNORSK (77%), MAORI (76%), FRENCH (76%), ZULU (76%), MALAY (75%), IRISH (75%), ITALIAN (74%), AFRIKAANS (74%), XHOSA (74%), SOTHO (74%), CROATIAN (74%), PORTUGUESE (74%), OROMO (74%), ROMANIAN (74%), CATALAN (74%), HUNGARIAN (73%), TSONGA (73%), FINNISH (73%), SOMALI (73%), SLOVENE (72%), BOSNIAN (72%), ESTONIAN (71%), TURKISH (71%), CZECH (71%), ICELANDIC (70%), SLOVAK (70%) \n" +
    ...
    @ParameterizedTest
    fun testComputeConfidenceValues(
        text: String,
        expectedConfidenceValues: String,
    ) {
        ...
        val confidenceValuesString =
            confidenceValues.filter { it.value > 0.7 }.map { e ->
    ...
    @ParameterizedTest
    fun testDetectMultiLanguageOf(
        text: String,
        expectedSectionsString: String,
    ) {
        val sections = languageDetector.detectMultiLanguageOf(text)
        val sectionsString =
            sections.joinToString("\n") {
                val confidenceValueString =
                    it.confidenceValues.filter { e -> e.value > 0.7 }.map { e ->
