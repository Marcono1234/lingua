...
internal inline fun <T> createValueArrays(intValues: IntCollection, resultHandler: (indValuesIndices: ShortArray, values: IntArray) -> T): T {
    ...
    return if (indirectCost < directCost) {
        ...
        intValuesArray.forEachIndexedStartingAt(indirectLookupEndIndex) { index, i -> values[indirectValuesCount + index] = i }
